...
export default function CatDetailPage() {
  ...
  const PedigreeNode = ({ catIdNode, level, label }: { catIdNode: number | null, level: number, label: string }) => {
    ...
    const borderClass = isCurrent ? 'border-red-400 ring-4 ring-red-50' : cat.gender ? 'border-blue-200 hover:border-blue-400' : 'border-rose-200 hover:border-rose-400';
    const textThemeClass = isCurrent ? 'text-red-500' : cat.gender ? 'text-blue-500' : 'text-rose-500';
