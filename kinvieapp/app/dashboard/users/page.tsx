    ...
    <div className="space-y-10 animate-fade-in max-w-[1300px] mx-auto pb-16">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-serif font-black text-stone-800 flex items-center justify-center gap-3">
          Tài khoản & Đối tác <span className="text-2xl sm:text-4xl animate-bounce">👥</span>
        </h1>
        <p className="text-stone-500 mt-2 sm:mt-3 text-sm sm:text-lg">Quản lý người dùng, phân quyền bảo mật và chăm sóc khách hàng.</p>
      </div>
      ...
      <div className="relative group/section">
        ...
        <div className="relative bg-white/60 backdrop-blur-2xl rounded-[1.75rem] sm:rounded-[2.5rem] p-4 sm:p-8 md:p-10 border border-white/80 shadow-[0_8px_30px_rgba(0,0,0,0.03)] overflow-hidden transition-all duration-500 hover:border-cyan-200/80 hover:shadow-[0_8px_50px_rgba(6,182,212,0.1)]">
