    ...
    <div className="space-y-10 animate-fade-in max-w-[1300px] mx-auto pb-16">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-serif font-black text-stone-800 flex items-center justify-center gap-3">
          Kinh doanh & Vận hành <span className="text-4xl animate-pulse">⚙️</span>
        </h1>
        <p className="text-stone-500 mt-3 text-lg">Hệ thống trung tâm kiểm soát doanh thu, đơn hàng và nhân sự.</p>
      </div>
      ...
      <div className="relative group/section">
        ...
        <div className="relative bg-white/60 backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-10 border border-white/80 shadow-[0_8px_30px_rgba(0,0,0,0.03)] overflow-hidden transition-all duration-500 hover:border-blue-200/80 hover:shadow-[0_8px_50px_rgba(59,130,246,0.1)]">
